...
class INISWebSpider(CrawlSpider):
    """INIS crawler
    ...
    example usage:
    scrapy crawl INISweb -a source_file=file://`pwd`/tests/responses/inis/records_1.htm -s "JSON_OUTPUT_DIR=tmp/"
    ...
    def __init__(self, source_file=None, *args, **kwargs):
        ...
        super(INISWebSpider, self).__init__(*args, **kwargs)
